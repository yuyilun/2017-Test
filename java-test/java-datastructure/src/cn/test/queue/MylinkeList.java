...
public class MylinkeList<T> implements Serializable, IList<T>, Iterable<T> {
	...
	/**
	 * 清空数据,GC更容易回收 Blog : http://blog.csdn.net/javazejian
	 */
	@Override
	public void clear() {
	...
	/**
	 * 根据值查下标 Blog : http://blog.csdn.net/javazejian
	 * 
	 * @param data
	 * @return
	 */
	...
	/**
	 * 根据data查询最后一个下标 Blog : http://blog.csdn.net/javazejian
	 * 
	 * @param data
	 * @return
	 */
	...
	/**
	 * 删除x结点 Blog : http://blog.csdn.net/javazejian
	 * 
	 * @param x
	 * @return
	 */
	...
	/**
	 * 在succ结点前插入 Blog : http://blog.csdn.net/javazejian
	 */
	...
	/**
	 * 链表头部添加,由于拥有头结点和尾结点,无需判断插入情况 Blog : http://blog.csdn.net/javazejian
	 * 
	 * @param data
	 */
	...
	/**
	 * 链表尾部添加,由于拥有头结点和尾结点,无需判断插入情况 Blog : http://blog.csdn.net/javazejian
	 * 
	 * @param data
	 */
	...
	/**
	 * 优化结点查询,根据情况而定查询起点 Blog : http://blog.csdn.net/javazejian
	 * 
	 * @param index
	 * @return
	 */
	...
	/**
	 * 判断index是否越界 Blog : http://blog.csdn.net/javazejian
	 * 
	 * @param index
	 */
	...
	/**
	 * 迭代器,支持变量过程删除结点 Blog : http://blog.csdn.net/javazejian
	 */
	...
	/**
	 * 含前后指向的迭代器,支持变量过程添加元素,删除元素 Blog : http://blog.csdn.net/javazejian
	 */
	...
	/**
	 * 双向结点类 Blog : http://blog.csdn.net/javazejian
	 * 
	 * @param <T>
	 */
