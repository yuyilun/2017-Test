...
public class HelloGeneratorClass  implements Opcodes{
    ...
    public static byte[] generatorHelloClass() throws Exception {
        ...
        FieldVisitor fv;
        MethodVisitor mv;
        cw.visit(V1_8, ACC_PUBLIC + ACC_SUPER, "cn/test/proxy/asm/Hello", null, "java/lang/Object", null);
        ...
        }
        {
            ...
            mv.visitFrame(Opcodes.F_FULL, 8,
                    new Object[] { "cn/test/proxy/asm/Hello", Opcodes.INTEGER, "[Ljava/util/Map;",
            ...
            mv.visitLabel(l2);
            mv.visitFrame(Opcodes.F_FULL, 4, new Object[] { "cn/test/proxy/asm/Hello", Opcodes.INTEGER,
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> helloClass = myClassLoader.defineClassForName("cn.test.proxy.asm.Hello", data);
